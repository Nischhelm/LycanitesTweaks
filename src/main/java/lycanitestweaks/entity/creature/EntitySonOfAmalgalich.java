package lycanitestweaks.entity.creature;
...
public class EntitySonOfAmalgalich extends BaseCreatureEntity implements IMob, IGroupHeavy, IGroupBoss {
    ...
    // ==================================================
 	//                    Constructor
 	// ==================================================
    public EntitySonOfAmalgalich(World world) {
        super(world);
    ...
    public void onFirstSpawn() {
        ...
        if(!this.hasHome()){
            ...
            this.setHome(spawnPos.getX(), spawnPos.getY(), spawnPos.getZ(), 64F);
        }
...
//        }
    ...
    public void onLivingUpdate() {
        ...
        // Arena Snapping:
        if(this.hasArenaCenter() && !this.hasHome()) {
//            BlockPos arenaPos = this.getArenaCenter();
//            this.setHome(arenaPos.getX(), arenaPos.getY(), arenaPos.getZ(), 64F);
