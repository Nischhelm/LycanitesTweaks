...
public class LycanitesTweaksKeybindsCapability implements ILycanitesTweaksKeybindsCapability {
    ...
    LycanitesTweaksKeybindsCapability(){}

    LycanitesTweaksKeybindsCapability(@Nonnull EntityPlayer player){
        this.player = player;
    }

    public static ILycanitesTweaksKeybindsCapability getForPlayer(EntityPlayer player) {
        if (player == null) {
            return null;
        }
        ILycanitesTweaksKeybindsCapability playerKeybinds = player.getCapability(LycanitesTweaksKeybindsCapabilityHandler.LT_KEYBINDS, null);
