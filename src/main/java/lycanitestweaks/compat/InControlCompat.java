...
public class InControlCompat {
    ...
    public static final Key<Boolean> IS_MINION = Key.create(Type.BOOLEAN, "lycanites_isminion");
    ...
    public static final Key<Integer> ADD_LEVEL_RAND_MIN = Key.create(Type.INTEGER, "lycanites_addlevelrandmin");
