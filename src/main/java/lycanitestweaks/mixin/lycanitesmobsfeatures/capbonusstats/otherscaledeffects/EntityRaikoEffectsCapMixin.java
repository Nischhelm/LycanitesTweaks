...
public abstract class EntityRaikoEffectsCapMixin {
    ...
    public int lycanitesTweaks_lycanitesMobsEntityRaiko_dropPickupEntityEffectLevelLimit(int original){
        if(ForgeConfigHandler.getLevelLimitedEffects().containsKey("raiko")){
            return Helpers.getEffectDurationLevelLimited((BaseCreatureEntity)(Object)this, 5, ForgeConfigHandler.getLevelLimitedEffects().get("raiko"));
        }
        return original;
    }
}
