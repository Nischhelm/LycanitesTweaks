...
public abstract class EntityQuetzodraclEffectsCapMixin {
    ...
    public int lycanitesTweaks_lycanitesMobsEntityQuetzodracl_dropPickupEntityEffectLevelLimit(int original){
        if(ForgeConfigHandler.getLevelLimitedEffects().containsKey("quetzodracl")){
            return Helpers.getEffectDurationLevelLimited((BaseCreatureEntity)(Object)this, 5, ForgeConfigHandler.getLevelLimitedEffects().get("quetzodracl"));
        }
        return original;
    }
}
