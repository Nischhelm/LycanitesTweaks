...
public abstract class AltarInfoRoyalArchvileCrystalForgeEventMixin {
    ...
    public boolean lycanitesTweaks_lycanitesMobsAltarInfoRoyalArchvile_activate(World instance, BlockPos pos, @Local BaseCreatureEntity altarBoss){
