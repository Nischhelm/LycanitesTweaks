...
public abstract class AltarInfoUmberLobberCrystalForgeEventMixin {
    ...
    public boolean lycanitesTweaks_lycanitesMobsAltarInfoUmberLobber_activate(World instance, BlockPos pos, @Local BaseCreatureEntity altarBoss){
