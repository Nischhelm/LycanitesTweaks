...
public abstract class AltarInfoPhosphorescentChupacabraCrystalForgeEventMixin {
    ...
    public boolean lycanitesTweaks_lycanitesMobsAltarInfoPhosphorescentChupacabra_activate(World instance, BlockPos pos, @Local BaseCreatureEntity altarBoss){
