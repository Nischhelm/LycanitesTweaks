...
public abstract class AltarInfoMottleAbaiaCrystalForgeEventMixin {
    ...
    public boolean lycanitesTweaks_lycanitesMobsAltarInfoMottleAbaia_activate(World instance, BlockPos pos, @Local BaseCreatureEntity altarBoss){
