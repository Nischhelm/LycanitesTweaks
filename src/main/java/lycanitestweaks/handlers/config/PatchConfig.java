...
public class PatchConfig {
    ...
    @Config.Comment("Fix various unused sound files with obvious intent that can not be fixed with sounds.json\n" +
            "Ignibus attack\n" +
            "Rahovart's hell fire wave launch\n" +
            "All rapid fire projectiles (Cinder, Serpix, Ignibus)")
    @Config.Name("General Sound Fixes")
    @Config.RequiresMcRestart
    @MixinConfig.MixinToggle(defaultValue = true, lateMixin = "mixins.lycanitestweaks.patches.soundfixes.json")
    public boolean generalSoundFixes = true;
