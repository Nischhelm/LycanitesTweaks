...
import lycanitestweaks.entity.creature.EntitySonOfAmalgalich;
...
public class ModelSonOfAmalgalich extends ModelCreatureObj {

	// ==================================================
  	//                    Constructors
  	// ==================================================
    public ModelSonOfAmalgalich() {
        this(1.0F);
    }

    public ModelSonOfAmalgalich(float shadowSize) {
    	// Load Model:
    	this.initModel("sonofamalgalich", LycanitesMobs.modInfo, "entity/amalgalich");
	...
	public boolean canRenderPart(String partName, Entity entity, LayerCreatureBase layer, boolean trophy) {
    	if(layer != null && entity instanceof EntitySonOfAmalgalich) {
    		return ((EntitySonOfAmalgalich)entity).getConsumptionAnimation() > 0;
		}
	...
	public void animatePart(String partName, EntityLiving entity, float time, float distance, float loop, float lookY, float lookX, float scale) {
		...
		// Consumption:
		if(entity instanceof EntitySonOfAmalgalich && ((EntitySonOfAmalgalich)entity).getConsumptionAnimation() > 0) {
			float consumptionScale = ((EntitySonOfAmalgalich)entity).getConsumptionAnimation();
